...
public:
   ...
   void code();
   CgenNodeP root();
   static int get_next_label() { return next_label++; }
};
...
public:
   ...
   const std::vector<CgenNodeP>& get_children() const { return children; }
   void set_parentnd(CgenNodeP p);
   CgenNodeP get_parentnd() { return parentnd; }
   int basic() { return basic_status == Basic; }

   void construct_attribute_table();
   std::vector<std::pair<Symbol, attr_class*>> get_attribute_table() const { return attribute_table; }
   std::map<Symbol, size_t> get_attribute_offset_map() const { return attribute_offset_map; }

   void construct_dispatch_table();
   std::vector<std::pair<Symbol, method_class*>> get_dispatch_table() const { return dispatch_table; }
   std::map<Symbol, size_t> get_dispatch_offset_map() const { return dispatch_offset_map; }
...
public:
   Tracker() : SymbolTable<Symbol, int>() {};
